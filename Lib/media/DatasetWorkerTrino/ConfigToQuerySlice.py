from media.ConfigHandlingTrino.SliceInfo import SliceInfo, GeneralSliceInfo, MediaSliceInfo
from media.DatasetWorkerTrino.QuerySliceInfo import QuerySliceInfo, MediaQuerySliceInfo
